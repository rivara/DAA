...
public class Jugadores_BT {
	...
	// algorimo de BT
	public static void BT(int v[], int etapa, boolean solucion[],
			boolean solucionMejor[]) {
		// for
	...
	public static boolean es_factible(int v[], int etapa, int intento,
			boolean solucion[], boolean solucionMejor[]) {
		int cont1 = 0;
		int cont2 = 0;
